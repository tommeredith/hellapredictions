                        ...
                        <div key={index} className="prediction">
                            ...
                            <div className="prediction__team team1">
                                <div className='prediction__team__logo'>
                                    <img alt={pred.team1} src={`https://plumpness-life-assets.s3.amazonaws.com/team_logos/${sport}/${LOGOS_NAME_MAP[sport][pred.team1]}.png`} />
                            ...
                            <div className="prediction__team team2">
                                <div className="prediction__team__logo">
                                    <img alt={pred.team2} src={`https://plumpness-life-assets.s3.amazonaws.com/team_logos/${sport}/${LOGOS_NAME_MAP[sport][pred.team2]}.png`} />
